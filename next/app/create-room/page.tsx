            ...
            <Card className="bg-neutral-950 w-[330px] h-[360px] border border-slate-800 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col justify-center items-center">
                        ...
                        <div className="m-[25px] text-white"><Input placeholder="Enter Room Name" ref={roomNameRef}></Input></div>
                ...
                <div className="flex justify-center items-center"><Button className="m-[25px]" onClick={handleCreateRoom}>Create</Button></div>
